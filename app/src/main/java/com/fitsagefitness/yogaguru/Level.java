...
public class Level extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionId = getIntent().getStringExtra("Program");
        setTitle(sessionId);
    ...
    public void Beginner(View view)
    {
        ...
        intent.putExtra("Program", sessionId);
    ...
    {
        Intent intent = new Intent(Level.this, Help.class);
        startActivity(intent);
    }
    ...
    private void inflateAd(NativeBannerAd nativeBannerAd) {
        ...
        LayoutInflater inflater = LayoutInflater.from(Level.this);
        ...
        AdOptionsView adOptionsView = new AdOptionsView(Level.this, nativeBannerAd, nativeAdLayout);
