...
public class Help extends AppCompatActivity {
    ...
    public void expandA1(View view)
    {
            t1.setText(R.string.answerOne);
            t1.setMaxLines(Integer.MAX_VALUE);

    }

    public void expandA2(View view)
    {
        t2.setText(R.string.answer2);
            t2.setMaxLines(Integer.MAX_VALUE);

    }

    public void expandA3(View view)
    {
        t3.setText(R.string.answer3);
            t3.setMaxLines(Integer.MAX_VALUE);

    }

    public void expandA4(View view)
    {
        t4.setText(R.string.doct);
        t4.setMaxLines(Integer.MAX_VALUE);

    }

    public void expandA5(View view)
    {
        t5.setText("Attempt and perform the pose to your body limits, by regular practice you will get better at it.");
        t5.setMaxLines(Integer.MAX_VALUE);
    ...
    private void inflateAd(NativeBannerAd nativeBannerAd) {
        ...
        AdOptionsView adOptionsView = new AdOptionsView(Help.this, nativeBannerAd, nativeAdLayout);
